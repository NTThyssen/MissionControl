...
namespace MissionControl.Data
{
    public class TestStandMapping : ComponentMapping
    {
        ...
        public TestStandMapping()
        {
            ...
            SV_IPA = new ServoComponent(0, "SV_IPA", "SV_IPA");
            SV_N2O = new ServoComponent(0, "SV_N2O", "SV_N2O");
            MV_IPA = new ServoComponent(0, "MV_IPA", "MV_IPA");
            MV_N2O = new ServoComponent(0, "MV_N2O", "MV_N2O");

            SN_N2O_FILL = new SolenoidComponent(0, "SN_N2O_FILL", "SN_N2O_FILL");
            SN_FLUSH = new SolenoidComponent(0, "SN_FLUSH", "SN_FLUSH");
